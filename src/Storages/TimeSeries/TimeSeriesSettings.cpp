...
#define LIST_OF_TIME_SERIES_SETTINGS(DECLARE, ALIAS) \
    ...
    DECLARE(UInt64, insert_cache_max_size_bytes, 16777216, "Maximum memory used by the replica-local insert cache when 'store_min_time_and_max_time' is false. Set to 0 to disable the cache", 0) \
