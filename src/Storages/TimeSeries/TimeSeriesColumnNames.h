...
struct TimeSeriesColumnNames
{
    ...
    /// A row of a bucketed "samples" table contains the samples of one time series within one time bucket
    ...
    /// Tables of versions before 6 store one sample per row in the "samples" table in the columns "timestamp" and "value".
