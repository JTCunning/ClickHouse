...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.10",
        {
            ...
            {"enable_prometheus_remote_write_v2", false, false, "New setting to accept Prometheus Remote Write 2.0 (`io.prometheus.write.v2.Request`) on Prometheus write handlers. Native histograms are stored the same way as Remote Write 1.0. Added an alias `allow_experimental_prometheus_remote_write_v2`."},
        });
